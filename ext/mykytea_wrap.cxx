...
#define SWIGTYPE_p_std__pairT_KyteaString_double_t swig_types[26]
#define SWIGTYPE_p_std__pairT_std__string_double_t swig_types[27]
#define SWIGTYPE_p_std__vectorT_Tags_std__allocatorT_Tags_t_t swig_types[28]
#define SWIGTYPE_p_std__vectorT_double_std__allocatorT_double_t_t swig_types[29]
#define SWIGTYPE_p_std__vectorT_kytea__KyteaWord_std__allocatorT_kytea__KyteaWord_t_t swig_types[30]
#define SWIGTYPE_p_std__vectorT_std__pairT_KyteaString_double_t_std__allocatorT_std__pairT_KyteaString_double_t_t_t swig_types[31]
#define SWIGTYPE_p_std__vectorT_std__pairT_std__string_double_t_std__allocatorT_std__pairT_std__string_double_t_t_t swig_types[32]
...
SWIGINTERN VALUE std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__slice(std::vector< std::pair< std::string,double > > *self,std::vector< std::pair< std::string,double > >::difference_type i,std::vector< std::pair< std::string,double > >::difference_type length){
      if ( length < 0 )
        return Qnil;
      std::size_t len = self->size();
      if ( i < 0 ) {
        if ( i + static_cast<std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >::difference_type>(len) < 0 )
          return Qnil;
        else
          i = len + i;
      }
      std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >::difference_type j = length + i;
      if ( j > static_cast<std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >::difference_type>(len) )
        j = len;
...
SWIGINTERN VALUE std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg____getitem____SWIG_0(std::vector< std::pair< std::string,double > > const *self,std::vector< std::pair< std::string,double > >::difference_type i,std::vector< std::pair< std::string,double > >::difference_type length){
      if ( length < 0 )
        return Qnil;
      std::size_t len = self->size();
      if ( i < 0 ) {
...
SWIGINTERN VALUE std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg____setitem____SWIG_0(std::vector< std::pair< std::string,double > > *self,std::vector< std::pair< std::string,double > >::difference_type i,std::vector< std::pair< std::string,double > >::value_type const &x){
	if ( i >= static_cast<std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >::difference_type>( self->size()) )
          swig::resize( self, i+1, x );
        else
          *(swig::getpos(self, i)) = x;
...
SWIGINTERN VALUE std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg____setitem____SWIG_1(std::vector< std::pair< std::string,double > > *self,std::vector< std::pair< std::string,double > >::difference_type i,std::vector< std::pair< std::string,double > >::difference_type length,std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > const &v){
...
SWIGINTERN std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > *std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__reject_bang(std::vector< std::pair< std::string,double > > *self){
	...
	rb_raise( rb_eArgError, "no block given" );
      ...
      self->erase( std::remove_if( self->begin(), self->end(),
            swig::yield< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >::value_type >() ), self->end() );
      return self;
    }
...
SWIGINTERN std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > *std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__insert__SWIG_0(std::vector< std::pair< std::string,double > > *self,std::vector< std::pair< std::string,double > >::difference_type pos,int argc,VALUE *argv,...){
      ...
      int idx = 0;
      try {
	std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >::value_type val = swig::as<std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >::value_type>( elem );
	if ( i >= len ) {
	  self->resize(i-1, val);
	  return self;
	}
...
SWIGINTERN std::vector< std::pair< std::string,double > >::iterator std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__insert__SWIG_1(std::vector< std::pair< std::string,double > > *self,std::vector< std::pair< std::string,double > >::iterator pos,std::vector< std::pair< std::string,double > >::value_type const &x){ return self->insert(pos, x); }
SWIGINTERN void std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__insert__SWIG_2(std::vector< std::pair< std::string,double > > *self,std::vector< std::pair< std::string,double > >::iterator pos,std::vector< std::pair< std::string,double > >::size_type n,std::vector< std::pair< std::string,double > >::value_type const &x){ self->insert(pos, n, x); }
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg__slice(std::vector< std::vector< std::pair< std::string,double > > > *self,std::vector< std::vector< std::pair< std::string,double > > >::difference_type i,std::vector< std::vector< std::pair< std::string,double > > >::difference_type length){
      if ( length < 0 )
        return Qnil;
      std::size_t len = self->size();
      if ( i < 0 ) {
        if ( i + static_cast<std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >,std::allocator< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > >::difference_type>(len) < 0 )
          return Qnil;
        else
          i = len + i;
      }
      std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >,std::allocator< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > >::difference_type j = length + i;
      if ( j > static_cast<std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >,std::allocator< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > >::difference_type>(len) )
        j = len;
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg____getitem____SWIG_0(std::vector< std::vector< std::pair< std::string,double > > > const *self,std::vector< std::vector< std::pair< std::string,double > > >::difference_type i,std::vector< std::vector< std::pair< std::string,double > > >::difference_type length){
      if ( length < 0 )
        return Qnil;
      std::size_t len = self->size();
      if ( i < 0 ) {
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg____setitem____SWIG_0(std::vector< std::vector< std::pair< std::string,double > > > *self,std::vector< std::vector< std::pair< std::string,double > > >::difference_type i,std::vector< std::vector< std::pair< std::string,double > > >::value_type const &x){
	if ( i >= static_cast<std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >,std::allocator< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > >::difference_type>( self->size()) )
          swig::resize( self, i+1, x );
        else
          *(swig::getpos(self, i)) = x;
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg____setitem____SWIG_1(std::vector< std::vector< std::pair< std::string,double > > > *self,std::vector< std::vector< std::pair< std::string,double > > >::difference_type i,std::vector< std::vector< std::pair< std::string,double > > >::difference_type length,std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >,std::allocator< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > > const &v){
...
SWIGINTERN std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >,std::allocator< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > > *std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg__reject_bang(std::vector< std::vector< std::pair< std::string,double > > > *self){
	...
	rb_raise( rb_eArgError, "no block given" );
      ...
      self->erase( std::remove_if( self->begin(), self->end(),
            swig::yield< std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >,std::allocator< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > >::value_type >() ), self->end() );
      return self;
    }
...
SWIGINTERN std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >,std::allocator< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > > *std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg__insert__SWIG_0(std::vector< std::vector< std::pair< std::string,double > > > *self,std::vector< std::vector< std::pair< std::string,double > > >::difference_type pos,int argc,VALUE *argv,...){
      ...
      int idx = 0;
      try {
	std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >,std::allocator< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > >::value_type val = swig::as<std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >,std::allocator< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > >::value_type>( elem );
	if ( i >= len ) {
	  self->resize(i-1, val);
	  return self;
	}
...
SWIGINTERN std::vector< std::vector< std::pair< std::string,double > > >::iterator std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg__insert__SWIG_1(std::vector< std::vector< std::pair< std::string,double > > > *self,std::vector< std::vector< std::pair< std::string,double > > >::iterator pos,std::vector< std::vector< std::pair< std::string,double > > >::value_type const &x){ return self->insert(pos, x); }
SWIGINTERN void std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg__insert__SWIG_2(std::vector< std::vector< std::pair< std::string,double > > > *self,std::vector< std::vector< std::pair< std::string,double > > >::iterator pos,std::vector< std::vector< std::pair< std::string,double > > >::size_type n,std::vector< std::vector< std::pair< std::string,double > > >::value_type const &x){ self->insert(pos, n, x); }
...
SWIGINTERN VALUE std_vector_Sl_Tags_Sg__slice(std::vector< Tags > *self,std::vector< Tags >::difference_type i,std::vector< Tags >::difference_type length){
      if ( length < 0 )
        return Qnil;
      std::size_t len = self->size();
      if ( i < 0 ) {
        if ( i + static_cast<std::vector< Tags,std::allocator< Tags > >::difference_type>(len) < 0 )
          return Qnil;
        else
          i = len + i;
      }
      std::vector< Tags,std::allocator< Tags > >::difference_type j = length + i;
      if ( j > static_cast<std::vector< Tags,std::allocator< Tags > >::difference_type>(len) )
        j = len;
...
SWIGINTERN VALUE std_vector_Sl_Tags_Sg____getitem____SWIG_0(std::vector< Tags > const *self,std::vector< Tags >::difference_type i,std::vector< Tags >::difference_type length){
      if ( length < 0 )
        return Qnil;
      std::size_t len = self->size();
      if ( i < 0 ) {
...
SWIGINTERN VALUE std_vector_Sl_Tags_Sg____setitem____SWIG_0(std::vector< Tags > *self,std::vector< Tags >::difference_type i,std::vector< Tags >::value_type const &x){
	if ( i >= static_cast<std::vector< Tags,std::allocator< Tags > >::difference_type>( self->size()) )
          swig::resize( self, i+1, x );
        else
          *(swig::getpos(self, i)) = x;
...
SWIGINTERN VALUE std_vector_Sl_Tags_Sg____setitem____SWIG_1(std::vector< Tags > *self,std::vector< Tags >::difference_type i,std::vector< Tags >::difference_type length,std::vector< Tags,std::allocator< Tags > > const &v){
...
SWIGINTERN std::vector< Tags,std::allocator< Tags > > *std_vector_Sl_Tags_Sg__reject_bang(std::vector< Tags > *self){
	...
	rb_raise( rb_eArgError, "no block given" );
      ...
      self->erase( std::remove_if( self->begin(), self->end(),
            swig::yield< std::vector< Tags,std::allocator< Tags > >::value_type >() ), self->end() );
      return self;
    }
...
SWIGINTERN std::vector< Tags,std::allocator< Tags > > *std_vector_Sl_Tags_Sg__insert__SWIG_0(std::vector< Tags > *self,std::vector< Tags >::difference_type pos,int argc,VALUE *argv,...){
      ...
      int idx = 0;
      try {
	std::vector< Tags,std::allocator< Tags > >::value_type val = swig::as<std::vector< Tags,std::allocator< Tags > >::value_type>( elem );
	if ( i >= len ) {
	  self->resize(i-1, val);
	  return self;
	}
...
SWIGINTERN std::vector< Tags >::iterator std_vector_Sl_Tags_Sg__insert__SWIG_1(std::vector< Tags > *self,std::vector< Tags >::iterator pos,std::vector< Tags >::value_type const &x){ return self->insert(pos, x); }
SWIGINTERN void std_vector_Sl_Tags_Sg__insert__SWIG_2(std::vector< Tags > *self,std::vector< Tags >::iterator pos,std::vector< Tags >::size_type n,std::vector< Tags >::value_type const &x){ self->insert(pos, n, x); }
...
/*
  Document-method: Mykytea::StringVector.delete
...
static swig_class SwigClassPairsd;
...
_wrap_new_Pairsd__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    if (!SWIG_IsOK(res) || !ptr) {
      SWIG_exception_fail(SWIG_ArgError((ptr ? res : SWIG_TypeError)), Ruby_Format_TypeError( "", "std::string","pair<(std::string,double)>", 1, argv[0] )); 
    }
    arg1 = *ptr;
  ...
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), Ruby_Format_TypeError( "", "double","pair<(std::string,double)>", 2, argv[1] ));
  } 
...
_wrap_new_Pairsd__SWIG_2(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    res1 = swig::asptr(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::pair< std::string,double > const &","pair<(std::string,double)>", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::pair< std::string,double > const &","pair<(std::string,double)>", 1, argv[0])); 
    }
    arg1 = ptr;
  }
...
SWIGINTERN void
free_std_pair_Sl_std_string_Sc_double_Sg_(void *self) {
    std::pair< std::string,double > *arg1 = (std::pair< std::string,double > *)self;
    delete arg1;
}

static swig_class SwigClassPairVector;
...
_wrap_new_PairVector__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    res1 = swig::asptr(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::pair< std::string,double > > const &","vector<(std::pair<(std::string,double)>)>", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::pair< std::string,double > > const &","vector<(std::pair<(std::string,double)>)>", 1, argv[0])); 
    }
    arg1 = ptr;
  }
...
_wrap_new_PairVector__SWIG_2(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_size_t(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "std::vector< std::pair< std::string,double > >::size_type","vector<(std::pair<(std::string,double)>)>", 1, argv[0] ));
  } 
...
_wrap_new_PairVector__SWIG_3(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = static_cast< std::vector< std::pair< std::string,double > >::size_type >(val1);
  {
    ...
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::vector< std::pair< std::string,double > >::value_type const &","vector<(std::pair<(std::string,double)>)>", 2, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::pair< std::string,double > >::value_type const &","vector<(std::pair<(std::string,double)>)>", 2, argv[1])); 
    }
    arg2 = ptr;
  }
...
_wrap_PairVector_insert__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  result = std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__insert__SWIG_1(arg1,arg2,(std::pair< std::string,double > const &)*arg3);
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< std::pair< std::string,double > >::iterator & >(result),
      self),
    swig::Iterator::descriptor(),SWIG_POINTER_OWN);
  if (SWIG_IsNewObj(res3)) delete arg3;
...
_wrap_PairVector_insert__SWIG_2(int argc, VALUE *argv, VALUE self) {
  ...
  std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__insert__SWIG_2(arg1,arg2,arg3,(std::pair< std::string,double > const &)*arg4);
  if (SWIG_IsNewObj(res4)) delete arg4;
  return Qnil;
fail:
  if (SWIG_IsNewObj(res4)) delete arg4;
...
SWIGINTERN void
free_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg_(void *self) {
    std::vector< std::pair< std::string,double > > *arg1 = (std::vector< std::pair< std::string,double > > *)self;
    delete arg1;
}

static swig_class SwigClassPairVectorVector;
...
_wrap_new_PairVectorVector__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    res1 = swig::asptr(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > const &","vector<(std::vector<(std::pair<(std::string,double)>)>)>", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > const &","vector<(std::vector<(std::pair<(std::string,double)>)>)>", 1, argv[0])); 
    }
    arg1 = ptr;
  }
...
_wrap_new_PairVectorVector__SWIG_2(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_size_t(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "std::vector< std::vector< std::pair< std::string,double > > >::size_type","vector<(std::vector<(std::pair<(std::string,double)>)>)>", 1, argv[0] ));
  } 
...
_wrap_new_PairVectorVector__SWIG_3(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = static_cast< std::vector< std::vector< std::pair< std::string,double > > >::size_type >(val1);
  {
    ...
    res2 = swig::asptr(argv[1], &ptr);
    if (!SWIG_IsOK(res2)) {
      SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::vector< std::vector< std::pair< std::string,double > > >::value_type const &","vector<(std::vector<(std::pair<(std::string,double)>)>)>", 2, argv[1] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< std::vector< std::pair< std::string,double > > >::value_type const &","vector<(std::vector<(std::pair<(std::string,double)>)>)>", 2, argv[1])); 
    }
    arg2 = ptr;
  }
...
_wrap_PairVectorVector_insert__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  result = std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg__insert__SWIG_1(arg1,arg2,(std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > const &)*arg3);
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< std::vector< std::pair< std::string,double > > >::iterator & >(result),
      self),
    swig::Iterator::descriptor(),SWIG_POINTER_OWN);
  if (SWIG_IsNewObj(res3)) delete arg3;
...
_wrap_PairVectorVector_insert__SWIG_2(int argc, VALUE *argv, VALUE self) {
  ...
  std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg__insert__SWIG_2(arg1,arg2,arg3,(std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > const &)*arg4);
  if (SWIG_IsNewObj(res4)) delete arg4;
  return Qnil;
fail:
  if (SWIG_IsNewObj(res4)) delete arg4;
...
SWIGINTERN void
free_std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg_(void *self) {
    std::vector< std::vector< std::pair< std::string,double > > > *arg1 = (std::vector< std::vector< std::pair< std::string,double > > > *)self;
    delete arg1;
}

static swig_class SwigClassTagsVector;
...
_wrap_new_TagsVector__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    res1 = swig::asptr(argv[0], &ptr);
    if (!SWIG_IsOK(res1)) {
      SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "std::vector< Tags > const &","vector<(Tags)>", 1, argv[0] )); 
    }
    if (!ptr) {
      SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< Tags > const &","vector<(Tags)>", 1, argv[0])); 
    }
    arg1 = ptr;
  }
...
_wrap_new_TagsVector__SWIG_2(int argc, VALUE *argv, VALUE self) {
  ...
  ecode1 = SWIG_AsVal_size_t(argv[0], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), Ruby_Format_TypeError( "", "std::vector< Tags >::size_type","vector<(Tags)>", 1, argv[0] ));
  } 
...
_wrap_new_TagsVector__SWIG_3(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = static_cast< std::vector< Tags >::size_type >(val1);
  res2 = SWIG_ConvertPtr(argv[1], &argp2, SWIGTYPE_p_Tags,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "std::vector< Tags >::value_type const &","vector<(Tags)>", 2, argv[1] )); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "std::vector< Tags >::value_type const &","vector<(Tags)>", 2, argv[1])); 
  }
  arg2 = reinterpret_cast< std::vector< Tags >::value_type * >(argp2);
...
_wrap_TagsVector_insert__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  arg3 = reinterpret_cast< std::vector< Tags >::value_type * >(argp3);
  result = std_vector_Sl_Tags_Sg__insert__SWIG_1(arg1,arg2,(Tags const &)*arg3);
  vresult = SWIG_NewPointerObj(swig::make_nonconst_iterator(static_cast< const std::vector< Tags >::iterator & >(result),
      self),
    swig::Iterator::descriptor(),SWIG_POINTER_OWN);
  return vresult;
...
_wrap_TagsVector_insert__SWIG_2(int argc, VALUE *argv, VALUE self) {
  ...
  res4 = SWIG_ConvertPtr(argv[2], &argp4, SWIGTYPE_p_Tags,  0 );
  if (!SWIG_IsOK(res4)) {
  ...
  std_vector_Sl_Tags_Sg__insert__SWIG_2(arg1,arg2,arg3,(Tags const &)*arg4);
  return Qnil;
fail:
  return Qnil;
}
...
SWIGINTERN void
free_std_vector_Sl_Tags_Sg_(void *self) {
    std::vector< Tags > *arg1 = (std::vector< Tags > *)self;
    delete arg1;
}

static swig_class SwigClassKytea;
...
_wrap_new_Kytea__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_kytea__KyteaConfig, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "kytea::KyteaConfig *","Kytea", 1, argv[0] )); 
  }
...
SWIGINTERN void
free_kytea_Kytea(void *self) {
    kytea::Kytea *arg1 = (kytea::Kytea *)self;
    delete arg1;
}
...
static swig_class SwigClassKyteaWord;
...
SWIGINTERN void
free_kytea_KyteaWord(void *self) {
    kytea::KyteaWord *arg1 = (kytea::KyteaWord *)self;
    delete arg1;
}

static swig_class SwigClassKyteaSentence;
...
_wrap_new_KyteaSentence__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1, SWIGTYPE_p_KyteaString,  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "KyteaString const &","KyteaSentence", 1, argv[0] )); 
  }
  if (!argp1) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "KyteaString const &","KyteaSentence", 1, argv[0])); 
  }
  arg1 = reinterpret_cast< KyteaString * >(argp1);
  res2 = SWIG_ConvertPtr(argv[1], &argp2, SWIGTYPE_p_KyteaString,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "KyteaString const &","KyteaSentence", 2, argv[1] )); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "KyteaString const &","KyteaSentence", 2, argv[1])); 
  }
  arg2 = reinterpret_cast< KyteaString * >(argp2);
  {
    try{
...
SWIGINTERN void
free_kytea_KyteaSentence(void *self) {
    kytea::KyteaSentence *arg1 = (kytea::KyteaSentence *)self;
    delete arg1;
}

static swig_class SwigClassTags;
...
static swig_class SwigClassMykytea;
...
SWIGINTERN void
free_Mykytea(void *self) {
    Mykytea *arg1 = (Mykytea *)self;
    delete arg1;
}
