...
SWIGINTERN VALUE std_pair_Sl_std_string_Sc_double_Sg__inspect(std::pair< std::string,double > const *self){
      VALUE tmp;
      VALUE str = rb_str_new2( swig::type_name< std::pair<std::string,double > >() );
      str = rb_str_cat2( str, " (" );
...
SWIGINTERN VALUE std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__inspect(std::vector< std::pair< std::string,double > > *self){
      ...
      VALUE str = rb_str_new2( swig::type_name< std::vector<std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > >() );
      str = rb_str_cat2( str, " [" );
      bool comma = false;
      VALUE tmp;
      for ( ; i != e; ++i, comma = true )
...
SWIGINTERN VALUE std_vector_Sl_std_vector_Sl_std_pair_Sl_std_string_Sc_double_Sg__Sg__Sg__inspect(std::vector< std::vector< std::pair< std::string,double > > > *self){
      ...
      VALUE str = rb_str_new2( swig::type_name< std::vector<std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > >,std::allocator< std::vector< std::pair< std::string,double >,std::allocator< std::pair< std::string,double > > > > > >() );
      str = rb_str_cat2( str, " [" );
      bool comma = false;
      VALUE tmp;
      for ( ; i != e; ++i, comma = true )
...
SWIGINTERN VALUE std_vector_Sl_Tags_Sg__inspect(std::vector< Tags > *self){
      ...
      VALUE str = rb_str_new2( swig::type_name< std::vector<Tags,std::allocator< Tags > > >() );
      str = rb_str_cat2( str, " [" );
      bool comma = false;
      VALUE tmp;
      for ( ; i != e; ++i, comma = true )
...
_wrap_new_Kytea__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(argv[0], &argp1,SWIGTYPE_p_KyteaConfig, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
...
_wrap_Kytea_getWSModel(int argc, VALUE *argv, VALUE self) {
  ...
  vresult = SWIG_NewPointerObj(SWIG_as_voidptr(result), SWIGTYPE_p_KyteaModel, 0 |  0 );
  return vresult;
fail:
  return Qnil;
}
...
_wrap_Kytea_setWSModel(int argc, VALUE *argv, VALUE self) {
  ...
  arg1 = reinterpret_cast< kytea::Kytea * >(argp1);
  res2 = SWIG_ConvertPtr(argv[0], &argp2,SWIGTYPE_p_KyteaModel, 0 |  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "KyteaModel *","setWSModel", 2, argv[0] )); 
  }
...
_wrap_new_KyteaWord(int argc, VALUE *argv, VALUE self) {
  ...
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "KyteaString const &","kytea::KyteaWord", 2, argv[1] )); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "KyteaString const &","kytea::KyteaWord", 2, argv[1])); 
  }
...
_wrap_new_KyteaSentence__SWIG_1(int argc, VALUE *argv, VALUE self) {
  ...
  res2 = SWIG_ConvertPtr(argv[1], &argp2, SWIGTYPE_p_KyteaString,  0 );
  if (!SWIG_IsOK(res2)) {
    SWIG_exception_fail(SWIG_ArgError(res2), Ruby_Format_TypeError( "", "KyteaString const &","kytea::KyteaSentence", 2, argv[1] )); 
  }
  if (!argp2) {
    SWIG_exception_fail(SWIG_ValueError, Ruby_Format_TypeError("invalid null reference ", "KyteaString const &","kytea::KyteaSentence", 2, argv[1])); 
  }
  arg2 = reinterpret_cast< KyteaString * >(argp2);
  {
    try{
...
SWIGINTERN VALUE _wrap_new_KyteaSentence(int nargs, VALUE *args, VALUE self) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      void *vptr = 0;
      int res = SWIG_ConvertPtr(argv[1], &vptr, SWIGTYPE_p_KyteaString, 0);
      _v = SWIG_CheckState(res);
      if (_v) {
...
SWIGEXPORT void Init_Mykytea(void) {
  ...
  rb_define_method(SwigClassKytea.klass, "getWSModel", VALUEFUNC(_wrap_Kytea_getWSModel), -1);
  rb_define_method(SwigClassKytea.klass, "setWSModel", VALUEFUNC(_wrap_Kytea_setWSModel), -1);
  rb_define_method(SwigClassKytea.klass, "checkEqual", VALUEFUNC(_wrap_Kytea_checkEqual), -1);
  ...
  rb_define_method(SwigClassKyteaWord.klass, "surface=", VALUEFUNC(_wrap_KyteaWord_surface_set), -1);
  rb_define_method(SwigClassKyteaWord.klass, "surface", VALUEFUNC(_wrap_KyteaWord_surface_get), -1);
  rb_define_method(SwigClassKyteaWord.klass, "norm=", VALUEFUNC(_wrap_KyteaWord_norm_set), -1);
  rb_define_method(SwigClassKyteaWord.klass, "norm", VALUEFUNC(_wrap_KyteaWord_norm_get), -1);
  ...
  rb_define_method(SwigClassKyteaSentence.klass, "surface=", VALUEFUNC(_wrap_KyteaSentence_surface_set), -1);
  rb_define_method(SwigClassKyteaSentence.klass, "surface", VALUEFUNC(_wrap_KyteaSentence_surface_get), -1);
  rb_define_method(SwigClassKyteaSentence.klass, "norm=", VALUEFUNC(_wrap_KyteaSentence_norm_set), -1);
  rb_define_method(SwigClassKyteaSentence.klass, "norm", VALUEFUNC(_wrap_KyteaSentence_norm_get), -1);
