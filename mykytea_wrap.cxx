...
SWIGINTERN VALUE _wrap_TagsVector___setitem__(int nargs, VALUE *args, VALUE self) {
  ...
  if (argc == 3) {
    ...
    if (_v) {
      ...
      if (_v) {
        void *vptr = 0;
        int res = SWIG_ConvertPtr(argv[2], &vptr, SWIGTYPE_p_Tags, 0);
        _v = SWIG_CheckState(res);
        if (_v) {
...
SWIGINTERN VALUE _wrap_new_TagsVector(int nargs, VALUE *args, VALUE self) {
  ...
  if (argc == 2) {
    ...
    if (_v) {
      void *vptr = 0;
      int res = SWIG_ConvertPtr(argv[1], &vptr, SWIGTYPE_p_Tags, 0);
      _v = SWIG_CheckState(res);
      if (_v) {
  ...
  if (argc == 4) {
    ...
    if (_v) {
      ...
      if (_v) {
        ...
        if (_v) {
          void *vptr = 0;
          int res = SWIG_ConvertPtr(argv[3], &vptr, SWIGTYPE_p_Tags, 0);
          _v = SWIG_CheckState(res);
          if (_v) {
